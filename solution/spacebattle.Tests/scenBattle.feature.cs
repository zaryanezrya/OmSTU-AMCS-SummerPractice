...
namespace spacebattle.Tests
{
    ...
    public partial class ОпределяемВозможностиПеремещенияFeature : object, Xunit.IClassFixture<ОпределяемВозможностиПеремещенияFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "scenBattle.feature"
#line hidden
        
        public ОпределяемВозможностиПеремещенияFeature(ОпределяемВозможностиПеремещенияFeature.FixtureData fixtureData, spacebattle_Tests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-ru"), "", "Определяем возможности перемещения", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.TraitAttribute("FeatureTitle", "Определяем возможности перемещения")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                ОпределяемВозможностиПеремещенияFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                ОпределяемВозможностиПеремещенияFeature.FeatureTearDown();
            }
        }
    }
}
