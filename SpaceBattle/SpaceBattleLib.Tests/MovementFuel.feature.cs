...
namespace SpaceBattleLib.Tests
{
    ...
    public partial class ДвиженияТолькоПриДостаточномКоличествеТопливаFeature : object, Xunit.IClassFixture<ДвиженияТолькоПриДостаточномКоличествеТопливаFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "MovementFuel.feature"
#line hidden
        
        public ДвиженияТолькоПриДостаточномКоличествеТопливаFeature(ДвиженияТолькоПриДостаточномКоличествеТопливаFeature.FixtureData fixtureData, SpaceBattleLib_Tests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "", "Движения только при достаточном количестве топлива", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.TraitAttribute("FeatureTitle", "Движения только при достаточном количестве топлива")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                ДвиженияТолькоПриДостаточномКоличествеТопливаFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                ДвиженияТолькоПриДостаточномКоличествеТопливаFeature.FeatureTearDown();
            }
        }
    }
}
